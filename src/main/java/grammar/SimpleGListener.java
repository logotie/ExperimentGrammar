...
public interface SimpleGListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code assignstringnonmutablesingletype}
	 * labeled alternative in {@link SimpleGParser#assignment}.
	 * @param ctx the parse tree
	 */
	void enterAssignstringnonmutablesingletype(SimpleGParser.AssignstringnonmutablesingletypeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code assignstringnonmutablesingletype}
	 * labeled alternative in {@link SimpleGParser#assignment}.
	 * @param ctx the parse tree
	 */
	void exitAssignstringnonmutablesingletype(SimpleGParser.AssignstringnonmutablesingletypeContext ctx);
	/**
	 * Enter a parse tree produced by the {@code assigndigitsnonmutablesingletype}
	 * labeled alternative in {@link SimpleGParser#assignment}.
	 * @param ctx the parse tree
	 */
	void enterAssigndigitsnonmutablesingletype(SimpleGParser.AssigndigitsnonmutablesingletypeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code assigndigitsnonmutablesingletype}
	 * labeled alternative in {@link SimpleGParser#assignment}.
	 * @param ctx the parse tree
	 */
	void exitAssigndigitsnonmutablesingletype(SimpleGParser.AssigndigitsnonmutablesingletypeContext ctx);
	/**
