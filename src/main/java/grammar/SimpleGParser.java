...
public class SimpleGParser extends Parser {
	...
	public static class AssigntextnonmutableContext extends AssignmentContext {
		public TerminalNode ID() { return getToken(SimpleGParser.ID, 0); }
		public TerminalNode NONMUTABLE() { return getToken(SimpleGParser.NONMUTABLE, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public AssigntextnonmutableContext(AssignmentContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SimpleGListener ) ((SimpleGListener)listener).enterAssigntextnonmutable(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SimpleGListener ) ((SimpleGListener)listener).exitAssigntextnonmutable(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimpleGVisitor ) return ((SimpleGVisitor<? extends T>)visitor).visitAssigntextnonmutable(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final AssignmentContext assignment() throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				break;
			case 8:
				_localctx = new AssigntextnonmutableContext(_localctx);
