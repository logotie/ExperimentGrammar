...
public interface SimpleGVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code assignstringnonmutablesingletype}
	 * labeled alternative in {@link SimpleGParser#assignment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssignstringnonmutablesingletype(SimpleGParser.AssignstringnonmutablesingletypeContext ctx);
	/**
	 * Visit a parse tree produced by the {@code assigndigitsnonmutablesingletype}
	 * labeled alternative in {@link SimpleGParser#assignment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssigndigitsnonmutablesingletype(SimpleGParser.AssigndigitsnonmutablesingletypeContext ctx);
	/**
