...
assignment:
STRINGIDENT SINGLESPACE ID EQUALSIGN SINGLESPACE* STRINGCHARACTER expr STRINGCHARACTER #AssignString
|NUMIDENT SINGLESPACE ID EQUALSIGN  SINGLESPACE* expr #AssignDigits
|ARRIDENT SINGLESPACE ID EQUALSIGN SINGLESPACE* ARRSTART (arrvalue COMMA|arrvalue)+ ARREND #AssignObjArray
|VARIDENT SINGLESPACE ID EQUALSIGN SINGLESPACE* STRINGCHARACTER expr STRINGCHARACTER #AssignVarString
|VARIDENT SINGLESPACE ID EQUALSIGN  SINGLESPACE* expr #AssignVarDigits
;
