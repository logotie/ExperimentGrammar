...
|ARRIDENT SINGLESPACE ID EQUALSIGN ARRSTART (arrvalue COMMA|arrvalue)+ ARREND #AssignObjArray
|VARIDENT SINGLESPACE ID EQUALSIGN STRINGCHARACTER expr STRINGCHARACTER #AssignVarString
|VARIDENT SINGLESPACE ID EQUALSIGN  expr #AssignVarDigits
;
